...
string                  CurrentBlockchainStatus::deamon_url{"http:://127.0.0.1:11666"};
...
uint64_t                CurrentBlockchainStatus::import_fee {10000000}; // 0.01 xmr
        ...
        uint64_t block_height)
{
    ...
    else
    {
        ...
        uint64_t v2height = testnet ? 624634 : 592000;
